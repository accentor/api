{
  ...
  mocha = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "022442h234f8b129gri8nm4ga19sxb6lz8k0m5krpzlsc7p2xbzk";
      type = "gem";
    };
    version = "2.3.0";
  };
  ...
  rubocop-factory_bot = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0zx3a423xlh9a4zr74jc12iwjcljws8nv51kda87r1lnsa6kln8p";
      type = "gem";
    };
    version = "2.26.0";
  };
  ...
  wahwah = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "08d7hcya1gryc4hflm9x04id6hbvn4xz4jqcbk1a3f31pyvbj93m";
      type = "gem";
    };
    version = "1.6.1";
  };
