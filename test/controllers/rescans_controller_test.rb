...
class RescansControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should not get index for user' do
    ...
    assert_includes response.parsed_body['errors'], { 'policy' => 'rescan_runner_policy', 'type' => 'forbidden', 'action' => 'index?' }
  end
  ...
  test 'should get not show for user' do
    ...
    assert_response :forbidden
    assert_includes response.parsed_body['errors'], { 'policy' => 'rescan_runner_policy', 'type' => 'forbidden', 'action' => 'show?' }
  end
  ...
  test 'should not start rescan for user' do
    ...
    assert_response :forbidden
    assert_includes response.parsed_body['errors'], { 'policy' => 'rescan_runner_policy', 'type' => 'forbidden', 'action' => 'start?' }
  end
  ...
  test 'should not start all rescans for user' do
    ...
    assert_response :forbidden
    assert_includes response.parsed_body['errors'], { 'policy' => 'rescan_runner_policy', 'type' => 'forbidden', 'action' => 'start_all?' }
  end
