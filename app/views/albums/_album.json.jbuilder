...
json.image_500((album.image.present? && album.image.image.variable?) ? rails_representation_url(album.image.image.variant(resize: "500x500>")) : nil)
json.image_250((album.image.present? && album.image.image.variable?) ? rails_representation_url(album.image.image.variant(resize: "250x250>")) : nil)
json.image_100((album.image.present? && album.image.image.variable?) ? rails_representation_url(album.image.image.variant(resize: "100x100>")) : nil)
